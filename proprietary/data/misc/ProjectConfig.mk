...
CUSTOM_HAL_IMGSENSOR = s5k3m2_ofg_mipi_raw s5k3m2_sy_mipi_raw  ov8858R2A_mipi_raw ov8858sy_mipi_raw
CUSTOM_HAL_LENS = dw9800af bu6429af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = s5k3m2_sy_mipi_raw 
CUSTOM_HAL_MAIN_BACKUP_LENS = bu6429af
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3m2_ofg_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3m2_ofg_mipi_raw s5k3m2_sy_mipi_raw ov8858R2A_mipi_raw ov8858sy_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9800af bu6429af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = y
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = s5k3m2_sy_mipi_raw  
CUSTOM_KERNEL_MAIN_BACKUP_LENS = bu6429af
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3m2_ofg_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9800af
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW =
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = ov8858sy_mipi_raw
...
CUSTOM_MODEM = dwav6795_lwt_l1_lttg dwav6795_lwt_l1_lwg
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
# User to root Begin
UserToRoot = no
# User to root end
# Added Dewav Aging Test by yann
CUSTOM_DEWAV_AGING_TEST = yes
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L1.MP5.V1_DWAV6795.LWT.S.CU_TMP1
MTK_BWC_SUPPORT = yes
...
#++++++++++++版本品牌信息宏+++++++++++++++++++++++
#内部版本号
CUSTOM_INTERNAL_VERSION=EF168_GB_DW_L010
#外部版本号
CUSTOM_VERSION=EF168_DW_L010
#项目名 如simtelep_n9 对应vendor下的目录
CUSTOM_TARGET_PRODUCT=ef168_dw
#客户品牌
CUSTOM_TARGET_BRAND=PPTV
#设置里显示的型号如HTC One X
CUSTOM_PRODUCT_MODEL=KING 7S
#客户厂家名如HTC
CUSTOM_PRODUCT_MANUFACTURER=PPTV
#客户主板名称
CUSTOM_PRODUCT_BOARD=PPTV
#客户设备名称
CUSTOM_PRODUCT_DEVICE=KING7S
#客户项目名称
CUSTOM_PRODUCT_NAME=KING 7S
#客户自定义版本号
#CUSTOM_DISPLAY_VERSION=
#MTP在电脑端显示的名字
CUSTOM_MTP_NAME=KING7S
#++++++++++++版本品牌信息宏+++++++++++++++++++++++

# Dewav_Smart_Wake
CUST_DEWAV_SMART_WAKE = yes
# prebuilt apps
CUSTOMER_PREBUILT_APPS = yes
# RawDataTest app
RAW_DATA_TEST = yes
#FT_TERMINAL_TEST
FT_TERMINAL_TEST = no
...
#add SogouInput_CTA
MTK_SogouInput_CTA = no

#add for IR
REMOTE_CTRL_SUPPORT = yes
#CREATE_PROJECT_INFO=20150428153511
#jeeray 增加smartpa消除回音
